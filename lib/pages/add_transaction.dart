            ...
            children: [
              ...
              ChoiceChip(
                label: Text(
                  ...
                  style: TextStyle(
                    fontSize: 18.0,
                    color: type == "Crédito" ? Colors.white : Colors.black,
                  ),
                ),
                ...
                onSelected: (val) {
                  if (val) {
                    setState(() {
                      type = "Crédito";
                      if (note.isEmpty || note == "Débito") {
                        note = 'Crédito';
                      }
                    });
                  }
                },
                selected: type == "Crédito" ? true : false,
              ),
              SizedBox(
                width: 8.0,
              ),
              ChoiceChip(
                label: Text(
                  ...
                  style: TextStyle(
                    fontSize: 18.0,
                    color: type == "Débito" ? Colors.white : Colors.black,
                  ),
                ),
                selectedColor: Static.PrimaryColor,
                onSelected: (val) {
                  if (val) {
                    setState(() {
                      ...
                      if (note.isEmpty || note == "Crédito") {
                        note = 'Débito';
                      }
                    });
                  }
                },
                selected: type == "Débito" ? true : false,
              ),
            ],
          ),
          //
